  ...
  return (
    <div className="grid grid-cols-4 gap-4 p-4">
      ...
      <div className="bg-white shadow rounded-lg p-4 text-center border border-black">
        ...
        <span className="text-green-600 text-sm font-bold">+55% since yesterday</span>
      </div>
      ...
      <div className="bg-white shadow rounded-lg p-4 text-center border border-black">
        ...
        <span className="text-green-600 text-sm font-bold">+3% since last week</span>
      </div>
      ...
      <div className="bg-white shadow rounded-lg p-4 text-center border border-black">
        ...
        <span className="text-red-600 text-sm font-bold">-2% CO₂ emissions</span>
      </div>
      ...
      <div className="bg-white shadow rounded-lg p-4 text-center border border-black">
        ...
        <span className="text-green-600 text-sm font-bold">+5% than last month</span>
      </div>
    </div>
  );
};
